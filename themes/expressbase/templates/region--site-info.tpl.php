...
?>
  ...
  <footer id="site-footer" class="<?php print $classes; ?>">
    ...
    <div id="cu-footer" class="<?php print $class; ?>">
        <p><a href="//www.colorado.edu"><img src="<?php print $base_url . '/' . drupal_get_path('theme', 'expressbase'); ?>/images/cudenver/CUDenver-<?php print $beboulder['color']; ?>.png" alt="University of Colorado Denver" class="beboulder"/></a></p>
